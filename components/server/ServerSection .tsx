...
export const ServerSection = ({ label, role, sectionType, channelType, server }: ServerSearchProps) => {
    const { onOpen } = useModal()
    return (
        <div className="flex items-center justify-between py-2">
            <p className="text-xs uppercase font-semibold text-zinc-500ServerSectionServerSection">{label}</p>
