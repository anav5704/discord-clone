        ...
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isPDF && (
                        <div className="relative flex items-center p-2 mt-2 rounded-md bg-baackground/10 ">
            ...
            {canDeleteMessage && (
                <div className="hidden group-hover:flex itmes-center gap-x-2 absolute p-1 right-5 -top-2  dark:bg0-zinc-800 border rounded-sm">
                    {canEditMessage && (
                    ...
                    <ActionTooltip label="Delete">
                        <Trash onClick={() => onOpen("deleteMessage", { apiUrl: `${socketUrl}/${id}`, query: socketQuery })} className="cursor-pointer ml-auto h-4 w-4 text-zinc-500" />
                    </ActionTooltip>
                </div>
            )}
        </div>
